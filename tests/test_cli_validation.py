...
class TestPrescanArgvValidation:
    def test_invalid_context_window_ignored(self):
        ...
        with patch.dict(os.environ, {}, clear=False):
            os.environ.pop("WINNOW_CONTEXT_WINDOW", None)
            _prescan_argv(["treat", "current", "--context-window", "abc"])
            assert "WINNOW_CONTEXT_WINDOW" not in os.environ
    ...
    def test_valid_system_overhead_tokens_set(self):
        ...
        with patch.dict(os.environ, {}, clear=False):
            ...
            assert os.environ["WINNOW_SYSTEM_OVERHEAD_TOKENS"] == "25000"
            os.environ.pop("WINNOW_SYSTEM_OVERHEAD_TOKENS", None)
