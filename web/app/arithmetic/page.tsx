      ...
      <section className="mb-16">
        ...
        <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-[6ch]">
          ...
          <AsciiPanel label="break-even" tone="accent">
            {/* Backticked so the star in `T*` is code rather than an emphasis
                mark — `Ticks` resolves stars in plain text, and
                `app/routes.test.tsx` fails a page that leaves one behind. */}
            <p className="text-lead tracking-tight">
